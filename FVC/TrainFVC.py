...
from Common.Utils import DecodedFrameBuffer, calculate_bpp, cal_psnr, separate_aux_and_normal_params, Record, init
...
class TrainerFVC(Trainer):
    ...
    def init_optimizer(self):
        ...
        params_w_o_fusion, aux_params = separate_aux_and_normal_params(self.inter_frame_codec)
        ...
        optimizers = {
            TrainingStage.WITHOUT_FUSION: Adam(
            ...
            TrainingStage.WITH_FUSION: Adam(
    ...
    #     decode_buffer = DecodedFrameBuffer()
    #
    ...
    #     return rd_cost
    #
    # def save_ckpt(self, epoch: str, best_rd_cost: int, *args, **kwargs):
    #     ckpt = {
